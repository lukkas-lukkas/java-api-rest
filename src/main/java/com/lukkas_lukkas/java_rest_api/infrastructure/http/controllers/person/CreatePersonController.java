...
import com.lukkas_lukkas.java_rest_api.infrastructure.http.contracts.person.CreatePersonInterface;
...
public class CreatePersonController implements CreatePersonInterface {
    ...
    @PostMapping
    public ResponseEntity<PersonView> create(@Valid @RequestBody CreatePersonForm form) {
